                  ...
                  <div class="col-md-7">
                     <div class="main-description px-2">
                        ...
                        <div class="price-area">
                           <p class="old-price mb-1"><del></del> <span class="old-price-discount text-danger">(<?php echo $dis;?>% off)</span>
                           </p>
                           <p class="new-price text-bold mb-1"><i class="fa fa-inr" aria-hidden="true"></i>
                             <s> <?php echo $row['price']; ?></s>
                           </p>
                           <p class="new-price text-bold mb-1"><i class="fa fa-inr" aria-hidden="true"></i>
                        ...
                        <div class="buttons d-flex my-3">
                           <!-- <div class="block">
                              ...
                              { ?>
                           <div class="block">
                              <button class="shadow btn cus-btn"><a style="color:black;"
                                    href="addtocartdetail.php?pid=<?php echo $row['idproduct']; ?>">Add to cart</a></button>
                           </div>
                                 <?php }
                                 else
                                 {?>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-8 offset-lg-2">
               <div class="full">
                  <form name="form" enctype="multipart/form-data" action="feedback.php" method="post">
                     <fieldset>
                        <input type="hidden" name="pid" value="<?php echo $pid; ?>">
                     ...
                     while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        $qu = "select username from user where iduser in(select user_iduser from feedback where product_idproduct='$pid' and user_iduser='$uid')";
...
<script src="https://github.com/antennaio/jquery-bar-rating.git"></script>
<!-- jQery -->
