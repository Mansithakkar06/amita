...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $sql="select * from user where username='$myusername' and isAdmin='1'";
...
<html>
   ...
   <body class="sub_page">
      ...
      <!-- inner page section -->
      <section class="inner_page_head" style="background-color:grey;">
         ...
         <div class="container">         
            <div class="row">
               <div class="col-lg-8 offset-lg-2">
                ...
                <center><h6 class="frmtxt">Change Password?<a href="change_password.php">Clcik Here!</a></h6></center> -->
                  </div>
               </div>
            </div>
         </div>
