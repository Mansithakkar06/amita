      ...
      <div class="hero_area">
               ...
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="login.php">Inquiry</a>
                        </li> 
                        <li class="nav-item">
         ...
         <section class="slider_section ">
            <div class="slider_bg_box">
               <img src="images/sliderG.jpg" alt="">
            </div>
                        ...
                        <div class="row">
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                 ...
                                 <p>
                                   The living room is, undoubtedly, the soul of every house. But the sad part of today’s cosmopolitan lifestyle is that no matter which house you go to, you feel like you have entered the same living room
                                 </p>
                                 <div class="btn-box">
                           ...
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                 <h1>
                                    ...
                                    <br>
                                    No cliches for Valentine’s day, plan a night in with your better half
                                 </h1>
                                 <p>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                           <div class="box">
                             <div class="option_container">
                                 <div class="options">
                                   <a href="login.php" class="option1">Add To Cart</a>
                                   <!-- <a href="login.php" class="option2">Buy Now</a> -->
               ...
               <div class="col-md-4">
                   <div class="full">
                      <div class="logo_footer">
                        <a href="#"><img width="300px" height="80px" background-color="#f8f8f8" src="images/logo.png" alt="#" /></a>
                      </div>
                      <div class="information_f">
                        <p><strong>ADDRESS:</strong> A-7,Sahaj platinum, Nr.shivshakti School Sneh Plaza, I.O.C Road, Chandkheda, Ahmedabad.</p>
                        <p><strong>TELEPHONE:</strong> +91 96245 73883</p>
                        <p><strong>EMAIL:</strong> amitafurnishing@gmail.com</p>
                      </div>
                   </div>
               </div>
               <div class="col-md-8">
                  ...
                  <div class="col-md-7">
                     ...
                     <div class="widget_menu">
                        ...
                        <ul>
                           ...
                           <li><a href="login.php">Inquiry</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-md-6">
