...
<?php } ?>
<link rel="shortcut icon" type="image/png" href="<?php echo $RELATIVE_PATH ?>amita_logo.jpg"><link rel="icon" type="image/png" href="<?php echo $RELATIVE_PATH ?>amita_logo.jpg">
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<span class="brand-text">Amita Furnishing </span>
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
