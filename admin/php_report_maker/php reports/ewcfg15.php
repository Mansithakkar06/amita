...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'i7ep3SfBwceqzWv2'); // Random key for encryption
...
$PROJECT_ID = "{FA2D8B28-DDEE-4EC7-8A4D-299B7F9B1E7C}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "mydb", "qs" => "`", "qe" => "`");
