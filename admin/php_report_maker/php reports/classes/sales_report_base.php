...
class sales_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// name
		$this->name = new ReportField('sales_report_base', 'sales report', 'x_name', 'name', '`name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->name->Lookup = new ReportLookup('name', 'sales_report_base', TRUE, 'name', ["name","","",""], [], [], [], [], [], [], '`name` ASC', '');
		$this->name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['name'] = &$this->name;

		// date
		$this->date = new ReportField('sales_report_base', 'sales report', 'x_date', 'date', '`date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->date->Lookup = new ReportLookup('date', 'sales_report_base', TRUE, 'date', ["date","","",""], [], [], [], [], [], [], '`date` ASC', '');
		$this->date->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['date'] = &$this->date;

		// name1
		$this->name1 = new ReportField('sales_report_base', 'sales report', 'x_name1', 'name1', '`name1`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name1->Sortable = TRUE; // Allow sort
		$this->name1->DateFilter = "";
		$this->fields['name1'] = &$this->name1;

		// qty
		$this->qty = new ReportField('sales_report_base', 'sales report', 'x_qty', 'qty', '`qty`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// price
		$this->price = new ReportField('sales_report_base', 'sales report', 'x_price', 'price', '`price`', 4, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
