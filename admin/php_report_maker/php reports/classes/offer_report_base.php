...
/**
 * Table class for offer report
 */
class offer_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'offer_report_base';
		$this->TableName = 'offer report';
		$this->TableType = 'VIEW';
		...
		// name
		$this->name = new ReportField('offer_report_base', 'offer report', 'x_name', 'name', '`name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->name->Lookup = new ReportLookup('name', 'offer_report_base', TRUE, 'name', ["name","","",""], [], [], [], [], [], [], '`name` ASC', '');
		$this->name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['name'] = &$this->name;

		// start_date
		$this->start_date = new ReportField('offer_report_base', 'offer report', 'x_start_date', 'start_date', '`start_date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// end_date
		$this->end_date = new ReportField('offer_report_base', 'offer report', 'x_end_date', 'end_date', '`end_date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount
		$this->discount = new ReportField('offer_report_base', 'offer report', 'x_discount', 'discount', '`discount`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`offer report`";
	}
