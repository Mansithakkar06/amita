...
/**
 * Table class for feedback report
 */
class feedback_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'feedback_report_base';
		$this->TableName = 'feedback report';
		$this->TableType = 'VIEW';
		...
		// name
		$this->name = new ReportField('feedback_report_base', 'feedback report', 'x_name', 'name', '`name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->name->Lookup = new ReportLookup('name', 'feedback_report_base', TRUE, 'name', ["name","","",""], [], [], [], [], [], [], '`name` ASC', '');
		$this->name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['name'] = &$this->name;

		// name1
		$this->name1 = new ReportField('feedback_report_base', 'feedback report', 'x_name1', 'name1', '`name1`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name1->Sortable = TRUE; // Allow sort
		$this->name1->DateFilter = "";
		$this->fields['name1'] = &$this->name1;

		// date
		$this->date = new ReportField('feedback_report_base', 'feedback report', 'x_date', 'date', '`date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->date->Lookup = new ReportLookup('date', 'feedback_report_base', TRUE, 'date', ["date","","",""], [], [], [], [], [], [], '`date` ASC', '');
		$this->date->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['date'] = &$this->date;

		// description
		$this->description = new ReportField('feedback_report_base', 'feedback report', 'x_description', 'description', '`description`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`feedback report`";
	}
