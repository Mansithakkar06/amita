...
/**
 * Table class for appointment report
 */
class appointment_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'appointment_report_base';
		$this->TableName = 'appointment report';
		$this->TableType = 'VIEW';
		...
		// name
		$this->name = new ReportField('appointment_report_base', 'appointment report', 'x_name', 'name', '`name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->name->Lookup = new ReportLookup('name', 'appointment_report_base', TRUE, 'name', ["name","","",""], [], [], [], [], [], [], '`name` ASC', '');
		$this->name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['name'] = &$this->name;

		// date
		$this->date = new ReportField('appointment_report_base', 'appointment report', 'x_date', 'date', '`date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->date->Lookup = new ReportLookup('date', 'appointment_report_base', TRUE, 'date', ["date","","",""], [], [], [], [], [], [], '`date` ASC', '');
		$this->date->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['date'] = &$this->date;

		// name1
		$this->name1 = new ReportField('appointment_report_base', 'appointment report', 'x_name1', 'name1', '`name1`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`appointment report`";
	}
