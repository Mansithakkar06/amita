...
include "city_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from city where idcity=$id");
...
<div class="text-center align-items-center mb-4">
    <center><h1 class="h3 mb-0 text-gray-800 ml-3"></h1></center>
    <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
        ...
        <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>City</h1>
                <form class="form-inline" action="city_processes.php" method="POST">
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from city order by idcity");
                    $i=1;
                    while($row=mysqli_fetch_assoc($result))
                    {?>
                    <tbody>
                        <tr>
                            <td><?php echo $row['idcity']; ?></td>
                            <td><?php echo $row["name"]; ?></td>
                            <td><a href="city_index.php?edit=<?php echo $row["idcity"];?>" class="edit_btn">edit </a></td>
                            <td><a href="city_processes.php?delete=<?php echo $row["idcity"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                        </tr>
                    </tbody>
                    <?php
                    $i++;
