...
include "user_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from user where iduser=$id");
...
<div class="container-fluid">
  <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>Users</h1>
                <form class="form-inline" action="user_processes.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $id; ?>"><br>
                    <input type="text" name="name" disabled placeholder="Name" value="<?php echo $name; ?>" required><br>
                    <input type="text" name="email" disabled placeholder="Email" value="<?php echo $email; ?>" required><br>
                    <input type="text" name="phone" disabled placeholder="Phone number" value="<?php echo $phone; ?>" required><br>
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from user order by iduser desc");
                    $i=1;
                    ...
                    <tr>
                        ...
                        <td><a href="user_index.php?edit=<?php echo $row["iduser"];?>" class="edit_btn">ADD&nbsp;as&nbsp;Admin</a></td>
                        <td><a href="user_processes.php?delete=<?php echo $row["iduser"];?>" class="del_btn" onclick="return myfunc()">delete </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
