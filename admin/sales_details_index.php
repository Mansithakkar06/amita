...
include "sales_details_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from sales_details where sales_idsales=$id");
...
<div class="container-fluid">        <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>SALES DETAILS</h1>
                <form class="form-inline" action="sales_details_processes.php" method="POST">
                    <input type="hidden" name="sid" value="<?php echo $_GET['sid'];?>">
                    <input type="hidden" name="id" value="<?php echo $id;?>"><br>
                    <input type="text" name="qty" placeholder="qty" pattern="[0-9]+" value="<?php echo $qty; ?>" required><br>
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from sales_details where sales_idsales='$_GET[sid]'");
                    $i=1;
                    ...
                    <tr>
                        ...
                        <td><a href="sales_details_processes.php?delete=<?php echo $row["sales_idsales"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
