...
include "purchase_return_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from purchase_return where idpurchase_return=$id");
...
<div class="container-fluid">      <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <form class="form-inline" action="purchase_return_processes.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $id; ?>"><br>
                    <input type="hidden" name="date" placeholder="name" value="<?php echo date("y/m/d"); ?>"><br>
                    <select name="dropdown_p" required  class="mb-2">
                           ...
                           <?php
                              ...
                              {
                                 echo "<option value='".$row['idpurchase']."'>".$row['idpurchase']."</option>";
                              }
                           ?>
                          </select>&nbsp;&nbsp;
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from purchase_return order by idpurchase_return desc");
                    $i=1;
                    while($row=mysqli_fetch_assoc($result))
                    {?>
                    <tbody>
                    <tr>
                        <td><?php echo $row['idpurchase_return']; ?></td>
                        <td><?php echo $row["date"]; ?></td>
                        <td><?php 
                        $sql3="select name from supplier where idsupplier in(select supplier_idsupplier from purchase where idpurchase in(select purchase_idpurchase from purchase_return where idpurchase_return=$row[idpurchase_return]))";
                        $res3=mysqli_query($conn,$sql3);
                        $s=mysqli_fetch_array($res3)[0];
                        echo $s;
                        ?></td>
                        <td><a href="purchase_return_index.php?edit=<?php echo $row["idpurchase_return"];?>" class="edit_btn">edit </a></td>
                        <td><a href="purchase_return_processes.php?delete=<?php echo $row["idpurchase_return"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                        <td><a href="purchase_return_details_index.php?pid=<?php echo $row["purchase_idpurchase"];?>&prid=<?php echo $row["idpurchase_return"];?>" class="price_btn">set&nbsp;reason </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
