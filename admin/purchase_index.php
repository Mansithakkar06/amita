...
include "purchase_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from purchase where idpurchase=$id");
...
<div class="container-fluid">        <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>PURCHASE </h1>
                <form class="form-inline" action="purchase_processes.php" method="POST">
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from purchase order by idpurchase desc");
                    $i=1;
                    while($row=mysqli_fetch_assoc($result))
                    {?>
                    <tbody>
                    <tr>
                        <td><?php echo $row['idpurchase']; ?></td>
                        <td><?php 
                        $sql3="select name from supplier where idsupplier='$row[supplier_idsupplier]'";
                        ...
                        <td><a href="purchase_index.php?edit=<?php echo $row["idpurchase"];?>" class="edit_btn">edit </a></td>
                        <td><a href="purchase_processes.php?delete=<?php echo $row["idpurchase"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                        <td><a href="purchase_details_index.php?pid=<?php echo $row["idpurchase"];?>" class="price_btn">Add&nbsp;raw&nbsp;material </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
