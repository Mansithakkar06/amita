...
include "supplier_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from supplier where idsupplier=$id");
...
<div class="container-fluid">
  <center>
                ...
                <?php endif ?>
                <form class="form-inline" action="supplier_processes.php" method="POST">
                    ...
                    <input type="tel" name="phone_no" placeholder="+91" pattern="[0-9]{10}" value="<?php echo $phone_no; ?>" required><br>
                    <input type="text" name="address" placeholder="address" value="<?php echo $address; ?>" required><br>
                    <select name="dropdown_company" required class="mb-2">
                           ...
                           <?php
                              ...
                              {
                                 echo "<option value='".$row['idcompany_information']."'>".$row['name']."</option>";
                              }
                           ?>
                    </select>
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from supplier order by idsupplier desc");
                    $i=1;
                    ...
                    <tr>
                        ...
                        <?php 
                        $cid=$row['company_information_idcompany_information'];
                        $q="select name from company_information where idcompany_information='$cid'";
                        $resq=mysqli_query($conn,$q);
                        $rowq=mysqli_fetch_array($resq);
                        ?>
                        <td><?php echo $rowq[0]; ?></td>

                        <td><a href="supplier_index.php?edit=<?php echo $row["idsupplier"];?>" class="edit_btn">edit </a></td>
                        <td><a href="supplier_processes.php?delete=<?php echo $row["idsupplier"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
