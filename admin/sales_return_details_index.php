...
include "sales_return_details_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from sales_return_details where sales_return_idsales_return=$id");
    $data=mysqli_fetch_array($record);
    $qty=$data['qty'];
    $reason=$data['reason'];
    $product=$data['product_idproduct'];
}
?><html>
<head>
...
<div class="container-fluid">
  <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <form class="form-inline" action="sales_return_details_processes.php" method="POST">
                    <input type="hidden" name="srid" value="<?php echo $_GET['setreason']; ?>">
                    ...
                    <select name="dropdown" required class="mb-2">
                           ...
                           <?php
                           $srid=$_GET['srid'];
                              $sql="SELECT * FROM product where idproduct in(select product_idproduct from sales_details where sales_idsales='$srid')"; 
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from sales_return_details where sales_return_idsales_return in(select idsales_return from sales_return where sales_idsales='$srid')");
                    $i=1;
                    ...
                    <tr>
                        <td><?php 
                        $s="select sales_idsales from sales_return where idsales_return='$row[sales_return_idsales_return]'";
                        $res=mysqli_query($conn,$s);
                        $xxx=mysqli_fetch_array($res)[0];
                        echo $xxx;
                        ?></td>
                        <?php 
                        $pid=$row["product_idproduct"];
                        $qp="select name from product where idproduct='$pid'";
                        $resqp=mysqli_query($conn,$qp);
                        $rowqp=mysqli_fetch_array($resqp);
                        ?>
                        <td><?php echo $rowqp[0]; ?></td>
                        
                        <td><?php echo $row["qty"]; ?></td>
                        <td><?php echo $row["reason"]; ?></td>
                        <!-- <td><a href="sales_return_details_index.php?edit=<?php //echo $row["sales_return_idsales_return"];?>&srid=<?php //echo $row["sales_return_idsales_return"];?>" class="edit_btn">edit </a></td> -->
                        <td><a href="sales_return_details_processes.php?delete=<?php echo $row["sales_return_idsales_return"];?>" class="del_btn" onclick="return myfunc()">delete </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
