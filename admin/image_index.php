...
include "image_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from image where idimage=$id");
...
<div class="container-fluid">
  <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>IMAGE</h1>
                <form class="form-inline" action="image_processes.php" method="POST">
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from image order by idimage desc");
                    $i=1;
                    ...
                    <tr>
                        ...
                        <td><a href="image_index.php?edit=<?php echo $row["idimage"];?>" class="edit_btn">edit </a></td>
                        <td><a href="image_processes.php?delete=<?php echo $row["idimage"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
