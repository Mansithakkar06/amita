...
include "sales_return_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from sales_return where idsales_return=$id");
...
<div class="container-fluid">  <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>SALES RETURN</h1>
                <form class="form-inline" action="sales_return_processes.php" method="POST">
                    ...
                    <select name="dropdown" required class="mb-2">
                           ...
                           <?php
                              ...
                              {
                                 echo "<option value='".$row['idsales']."'>".$row['idsales']."</option>";
                              }
                           ?>
                          </select>&nbsp;&nbsp;
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from sales_return order by idsales_return desc");
                    $i=1;
                    while($row=mysqli_fetch_assoc($result))
                    {?>
                    <tbody>
                    <tr>
                        <td><?php echo $row['sales_idsales']; ?></td>
                        <td><?php echo $row["date"]; ?></td>
                        
                        <!-- <td><a href="sales_return_index.php?edit=<?php //echo $row["idsales_return"];?>" class="edit_btn">edit </a></td> -->
                        <td><a href="sales_return_processes.php?delete=<?php echo $row["sales_idsales"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                        <td><a href="sales_return_details_index.php?srid=<?php echo $row["sales_idsales"];?>" class="price_btn">set&nbsp;reason </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
