...
include "customized_product_processes.php";
if(isset($_GET['aid'])){
$aid = $_GET['aid'];
}
$name="";
...
{ 
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from customized_product where appointment_idappointment=$aid");
    $data=mysqli_fetch_array($record);
    $name=$data['name'];
    $height=$data['height'];
    $width=$data['width'];
    $design=$data['design'];
    $idappointment=$data['appointment_idappointment'];
}
?><html>
<head>
...
<div class="container-fluid">
  <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <form class="form-inline" action="customized_product_processes.php" method="POST">
                    <input type="hidden" name="aid" value="<?php echo $aid; ?>"><br>
                    <input type="hidden" name="id" value="<?php echo $id; ?>"><br>
                    <input type="text" name="name" placeholder="name" value="<?php echo $name; ?>" required><br>
                    <input type="text" name="height" placeholder="height" value="<?php echo $height; ?>" required><br>
                    <input type="text" name="width" placeholder="width" value="<?php echo $width; ?>" required><br>
                    <input type="text" name="design" placeholder="design" value="<?php echo $design; ?>" required><br>
                ...
                <table>
                    ...
                    <?php
                    if (isset($_GET['aid'])) {
                        $result = mysqli_query($conn, "select * from customized_product where appointment_idappointment='$aid' order by idcustomized_product desc");
                        $i = 1;
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tbody>
                    <tr>
                        <td><?php echo $row['idcustomized_product']; ?></td>
                        <td><?php echo $row["name"]; ?></td>
                        <td><?php echo $row["height"]; ?></td>
                        <td><?php echo $row["width"]; ?></td>
                        <td><?php echo $row["design"]; ?></td>
                        <td><a href="customized_product_index.php?edit=<?php echo $row["idcustomized_product"]; ?>&aid=<?php echo $aid; ?>" class="edit_btn">edit </a></td>
                        <td><a href="customized_product_processes.php?delete=<?php echo $row["idcustomized_product"]; ?>&aid=<?php echo $aid; ?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
