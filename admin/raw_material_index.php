...
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from raw_material where idraw_material=$id");
  ...
  <div class="container-fluid">
        <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>RAW MATERIAL</h1>
                <form class="form-inline" action="raw_material_processes.php" method="POST">
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from raw_material order by idraw_material desc");
                    $i=1;
                    while($row=mysqli_fetch_assoc($result))
                    {?>
                    <tbody>
                    <tr>
                        <td><?php echo $row['idraw_material']; ?></td>
                        <td><?php echo $row["name"]; ?></td>
                        <td><?php echo $row["qoh"]."m²"; ?></td>
                        <td><a href="raw_material_index.php?edit=<?php echo $row["idraw_material"];?>" class="edit_btn">edit </a></td>
                        <td><a href="raw_material_processes.php?delete=<?php echo $row["idraw_material"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                        <td><a href="raw_material_details_index.php?setprice=<?php echo $row["idraw_material"];?>" class="price_btn" >set&nbsp;price </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
