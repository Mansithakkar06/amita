...
include "category_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from category where idcategory=$id");
...
<div class="container-fluid">
  <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>CATEGORY</h1>
                <form class="form-inline" action="category_processes.php" method="POST">
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from category order by idcategory desc");
                    $i=1;
                    ...
                    <tr>
                        ...
                        <td><a href="category_index.php?edit=<?php echo $row["idcategory"];?>" class="edit_btn">edit </a></td>
                        <td><a href="category_processes.php?delete=<?php echo $row["idcategory"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
