...
include "brand_processes.php";
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $edit_state=true;
    $record=mysqli_query($conn,"select * from brand where idbrand=$id");
...
<div class="container-fluid">
  <center>
            <?php if(isset($_SESSION['message'])): ?>
                ...
                <?php endif ?>
                <h1>Brand</h1>
                <form class="form-inline" action="brand_processes.php" method="POST">
                ...
                <table>
                    ...
                    <?php
                    $result=mysqli_query($conn,"select * from brand order by idbrand desc");
                    $i=1;
                    ...
                    <tr>
                        ...
                        <td><a href="brand_index.php?edit=<?php echo $row["idbrand"];?>" class="edit_btn">edit </a></td>
                        <td><a href="brand_processes.php?delete=<?php echo $row["idbrand"];?>" class="del_btn" onclick="return deletefunc()">delete </a></td>
                    </tr>
                    </tbody>
                    <?php
                    $i++;
